...
export default function Playgroundherobanner() {
    ...
    useEffect(() => {
        ...
        const wrappedText = headingText.replace(
            /([^<>]+)(?=<p>|$)/g,
            text => text.split(' ').map(word => `<span>${word} </span>`).join('')
        );
        ...
        tl.fromTo(contentRef.current,
            ...
            .fromTo(".playground-herobanner-content-second-div-first-div-box-main",
                { y: 50, opacity: 0 },
                { y: 0, opacity: 1, stagger: 0.2, duration: 0.5 },
                "-=0.5"
            )
            .fromTo(".passkey-button-main",
        ...
        <div className="playground-hero-banner-main">
            <div className="container">
                <div className="playground-herobanner-content-main" ref={contentRef}>
                    <div className="playground-herobanner-content-first-div" ref={titleRef}>
                        <span>[Limited Availability]</span>
                        <h1 ref={headingRef}>
                            Experience the future of crypto and claim your <p>unique </p><p>prize</p>
                        </h1>
                    </div>
                    <div className="playground-herobanner-content-second-div">
                        <div className="playground-herobanner-content-second-div-first-div" ref={stepsRef}>
