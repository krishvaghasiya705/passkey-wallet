          ...
          <div className="container">
            <div className="home-herobanner-content">
              ...
              <div className="home-herobanner-content-two">
                <div
                  className="home-herobanner-content-two-pera"
                  ref={contentRef}
                >
                  <p>
                    Simplify wallet creation and funding for new web3 users
                    through biometric login
                  </p>
                </div>
                <div
                  className="home-herobanner-content-two-button-div-main"
                  ref={buttonsRef}
                >
                  <button type="button">
                    Try our demo
